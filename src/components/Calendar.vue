    ...
    <div>
      ...
      <div class="flex flex-wrap" v-if="month.days[0].weekday === 'lundi'">
        <div
          ...
          :key="i"
          :class="day.date === today ? 'text-center py-4 text-xl bg-secondary rounded-xl' : 'text-center py-4 text-xl'" style="width: 14.28%"
        >
          {{ day.date }}
        </div>
      </div>
      ...
      <div class="flex flex-wrap" v-else-if="month.days[0].weekday === 'mardi'">
        <div class="text-center py-4 text-xl" style="width: 14.28%"></div>
